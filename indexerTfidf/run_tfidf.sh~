...
hadoop jar tfidf.jar tf-idf-1 $INPUT $OUTPUT/tfidf1

printf "\nExecuting Job 2: Word Counts For Docs\n"
hadoop jar tfidf.jar tf-idf-2 $OUTPUT/tfidf1 $OUTPUT/tfidf2

printf "\nExecuting Job 3: Docs In Corpus and TF-IDF\n"
hadoop jar tfidf.jar tf-idf-3 $INPUT $OUTPUT/tfidf2 $OUTPUT/tfidf3 $TYPE
